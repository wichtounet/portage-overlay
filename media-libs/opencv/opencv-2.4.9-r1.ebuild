...
IUSE="cuda doc +eigen examples ffmpeg gstreamer gtk ieee1394 ipp jpeg jpeg2k opencl openexr opengl openmp pch png +python qt4 testprograms threads tiff v4l vtk xine libcxx static-libs"
REQUIRED_USE="
...
RDEPEND="
	...
	libcxx? (
		>=sys-libs/libcxx-0.0_p20131222
		>=sys-libs/libcxxrt-0.0_p20131222
	)
"
DEPEND="${RDEPEND}
	virtual/pkgconfig
	...
	libcxx? ( >=sys-devel/clang-3.3-r100 )
"
...
src_configure() {
	...
	if use libcxx; then
		...
		mycmakeargs+=(
			-DCMAKE_CXX_FLAGS="-std=c++11 -stdlib=libc++ -Wno-error=autological-pointer-compare -Wno-error=pointer-bool-conversion"
